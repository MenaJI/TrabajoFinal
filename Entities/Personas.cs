...
namespace ApiREST.Entities
{
    public class Personas
    {
        ...
        [ForeignKey("Fk_TipoDoc")] public TiposDocs TipoDoc { get; set; }

        public double NroDocumento { get; set; }

        public int Fk_Genero { get; set; }
        [ForeignKey("Fk_Genero")] public Generos Genero { get; set; }

        public int Fk_Localidad { get; set; }
        [ForeignKey("Fk_Localidad")] public Localidades Localidad { get; set; }
